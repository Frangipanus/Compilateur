...
let _menhir_action_02 =
  fun _endpos__1_ _startpos__1_ ->
    ...
    (
# 102 "parser.mly"
         ( { bexpr = ATrue; loc= (_startpos,_endpos) } )
# 541 "parser.ml"
     : (Ast.bexpr))
...
let _menhir_action_03 =
  fun _endpos__1_ _startpos__1_ ->
    ...
    (
# 103 "parser.mly"
          ( { bexpr = AFalse; loc= (_startpos,_endpos) } )
# 551 "parser.ml"
     : (Ast.bexpr))
...
let _menhir_action_04 =
  fun _endpos_n_ _startpos_n_ n ->
    ...
    (
# 104 "parser.mly"
            ( { bexpr = Int(n); loc= (_startpos,_endpos) } )
# 561 "parser.ml"
     : (Ast.bexpr))
...
let _menhir_action_05 =
  fun _endpos_id_ _startpos_id_ id ->
    ...
    (
# 105 "parser.mly"
               ( { bexpr = Ident(id); loc= (_startpos,_endpos) } )
# 571 "parser.ml"
     : (Ast.bexpr))
...
let _menhir_action_06 =
  fun _endpos_s_ _startpos_s_ s ->
    ...
    (
# 106 "parser.mly"
               ( { bexpr = String(s); loc= (_startpos,_endpos) } )
# 581 "parser.ml"
     : (Ast.bexpr))
...
let _menhir_action_07 =
  fun _endpos__2_ _startpos__1_ ->
    ...
    (
# 107 "parser.mly"
                ( { bexpr = Empty; loc= ((_startpos,_endpos)) } )
# 591 "parser.ml"
     : (Ast.bexpr))
...
# 607 "parser.ml"
    ...
    (
# 109 "parser.mly"
                                                               ( { bexpr = Eval(at, el); loc= (_startpos,_endpos) } )
# 614 "parser.ml"
     : (Ast.bexpr))
...
let _menhir_action_10 =
  fun _endpos_id_ _startpos_at_ at id ->
    ...
    (
# 110 "parser.mly"
                                 ({bexpr = (Eval({ bexpr = Ident(id); loc= (_startpos,_endpos) }, [at])) ; loc =  (_startpos,_endpos) } )
# 624 "parser.ml"
     : (Ast.bexpr))
...
# 112 "parser.mly"
    ( match at.bexpr with
      | Eval(at, el) -> { bexpr = Eval(at, el@[{bexpr = EFn(fb); loc = (_startpos,_endpos)}]) ; loc= (_startpos,_endpos) } 
      | _ -> { bexpr = Eval(at, [{bexpr = EFn(fb); loc = (_startpos,_endpos)}]); loc = (_startpos,_endpos)})
# 636 "parser.ml"
     : (Ast.bexpr))
...
# 115 "parser.mly"
                          ( 
      match at.bexpr with
      | Eval(at, el) -> { bexpr = Eval(at, el@[{bexpr = EFn({formal = []; annot = None; body = {bexpr = EBlock(b); loc = (_startpos, _endpos)}}); loc = (_startpos, _endpos)}]); loc= (_startpos,_endpos) }
      | _ -> { bexpr = Eval(at, [{bexpr = EFn({formal = []; annot = None; body = {bexpr = EBlock(b); loc = (_startpos, _endpos)}}); loc = (_startpos, _endpos)}]); loc= (_startpos,_endpos) } )
# 649 "parser.ml"
     : (Ast.bexpr))
...
# 657 "parser.ml"
    ...
    (
# 119 "parser.mly"
                                                     ( { bexpr = Brac(el); loc= (_startpos,_endpos) } )
# 664 "parser.ml"
     : (Ast.bexpr))
...
let _menhir_action_14 =
  fun _endpos__4_ _startpos_s_ s ty ->
    ...
    (
# 95 "parser.mly"
                                       ( { typ = AVar(s, Some(ty)); loc= (_startpos,_endpos) } )
# 674 "parser.ml"
     : (Ast.kokaType))
...
let _menhir_action_15 =
  fun _endpos_s_ _startpos_s_ s ->
    ...
    (
# 96 "parser.mly"
           ( { typ = AVar(s, None); loc= (_startpos,_endpos) } )
# 684 "parser.ml"
     : (Ast.kokaType))
...
let _menhir_action_16 =
  fun _endpos__3_ _startpos__1_ ty ->
    ...
    (
# 97 "parser.mly"
                          ( { typ = AType(ty); loc= (_startpos,_endpos) } )
# 694 "parser.ml"
     : (Ast.kokaType))
...
let _menhir_action_17 =
  fun _endpos__2_ _startpos__1_ ->
    ...
    (
# 98 "parser.mly"
            ( { typ = AEmpty; loc= (_startpos,_endpos) } )
# 704 "parser.ml"
     : (Ast.kokaType))
...
let _menhir_action_19 =
  fun _endpos_b_ _startpos__1_ b ->
    ...
    (
# 129 "parser.mly"
                   ( { bexpr = ETild (b); loc= (_startpos,_endpos) } )
# 722 "parser.ml"
     : (Ast.bexpr))
...
let _menhir_action_20 =
  fun _endpos_b_ _startpos__1_ b ->
    ...
    (
# 130 "parser.mly"
                     ( { bexpr = ENot(b); loc= (_startpos,_endpos) } )
# 732 "parser.ml"
     : (Ast.bexpr))
...
let _menhir_action_21 =
  fun _endpos_b_ _startpos_s_ b s ->
    ...
    (
# 131 "parser.mly"
                               ( { bexpr = EAsign(s, b); loc= (_startpos, _endpos) } )
# 742 "parser.ml"
     : (Ast.bexpr))
...
# 750 "parser.ml"
    ...
    (
# 132 "parser.mly"
                                      ( { bexpr = EBinop(b2,b1,b3); loc= (_startpos,_endpos) } )
# 757 "parser.ml"
     : (Ast.bexpr))
...
let _menhir_action_36 =
  fun _endpos_lst_ _startpos__1_ b1 b2 lst ->
    ...
    (
# 133 "parser.mly"
                                             ( { bexpr = EIf(b1, b2,lst); loc= (_startpos,_endpos) } )
# 962 "parser.ml"
     : (Ast.bexpr))
...
let _menhir_action_37 =
  fun _endpos_b2_ _startpos__1_ b1 b2 ->
    ...
    (
# 134 "parser.mly"
                                   ( { bexpr = EIf (b1, { bexpr = EReturn(b2); loc= (_startpos, _endpos) }, { bexpr = EBlock([]); loc= (_startpos, _endpos) }); loc= (_startpos,_endpos)} )
# 972 "parser.ml"
     : (Ast.bexpr))
...
let _menhir_action_38 =
  fun _endpos_f_ _startpos__1_ f ->
    ...
    (
# 135 "parser.mly"
                   ( { bexpr = EFn(f); loc= (_startpos,_endpos) } )
# 982 "parser.ml"
     : (Ast.bexpr))
...
let _menhir_action_39 =
  fun _endpos_e_ _startpos__1_ e ->
    ...
    (
# 136 "parser.mly"
                    ( { bexpr = EReturn(e); loc= (_startpos,_endpos) } )
# 992 "parser.ml"
     : (Ast.bexpr))
...
let _menhir_action_42 =
  fun _endpos__0_ ->
    ...
    (
# 140 "parser.mly"
                           ( { bexpr = EBlock([]); loc= (_startpos,_endpos) } )
# 1018 "parser.ml"
     : (Ast.bexpr))
...
let _menhir_action_43 =
  fun _endpos_s_ _startpos__1_ b2 b3 s ->
    ...
    (
# 141 "parser.mly"
                                             ( {bexpr = EIf(b2, b3, s); loc= (_startpos,_endpos) } )
# 1028 "parser.ml"
     : (Ast.bexpr))
...
let _menhir_action_46 =
  fun _endpos_s_ _startpos_s_ s ->
    ...
    (
# 124 "parser.mly"
             (if not(is_good s) then (raise  Error2) else {bexpr = EBlock(s); loc = (_startpos, _endpos)} )
# 1054 "parser.ml"
     : (Ast.bexpr))
...
let _menhir_action_50 =
  fun _endpos_at_ _startpos_at_ at ->
    ...
    (
# 87 "parser.mly"
               ( { typ = TAType(at); loc= (_startpos,_endpos) } )
# 1098 "parser.ml"
     : (Ast.kokaType))
...
let _menhir_action_51 =
  fun _endpos_res_ _startpos_at_ at res ->
    ...
    (
# 88 "parser.mly"
                                      ( { typ = TFun(at, res); loc = (_startpos,_endpos) } )
# 1108 "parser.ml"
     : (Ast.kokaType))
...
let _menhir_action_52 =
  fun _endpos_res_ _startpos__1_ res tl tl1 ->
    ...
    (
# 89 "parser.mly"
                                                                                                            ( { typ = TMulFun(tl1::tl, res); loc= (_startpos,_endpos) } )
# 1118 "parser.ml"
     : (Ast.kokaType))
...
let _menhir_action_53 =
  fun _endpos_res_ _startpos__1_ res tl ->
    ...
    (
# 90 "parser.mly"
                                                      ( { typ = TMulFun([tl], res); loc = (_startpos,_endpos) } )
# 1128 "parser.ml"
     : (Ast.kokaType))
...
let _menhir_action_54 =
  fun _endpos_res_ _startpos__1_ res ->
    ...
    (
# 91 "parser.mly"
                                    ( { typ = TMulFun([], res) ; loc = (_startpos,_endpos) } )
# 1138 "parser.ml"
     : (Ast.kokaType))
...
let _menhir_action_69 =
  fun _endpos_ty_ _startpos_s_ s ty ->
    ...
    (
# 73 "parser.mly"
                                      ( {param = (s, ty); loc= (_startpos,_endpos)} )
# 1270 "parser.ml"
     : (Ast.param))
...
# 1278 "parser.ml"
    ...
    (
# 82 "parser.mly"
    ( {res = (lst, t); loc= (_startpos,_endpos)} )
# 1285 "parser.ml"
     : (Ast.result))
...
let _menhir_action_80 =
  fun _endpos_b_ _startpos_b_ b ->
    ...
    (
# 149 "parser.mly"
              ( { stmt = SBexpr(b); loc = (_startpos,_endpos) } )
# 1369 "parser.ml"
     : (Ast.stmt))
...
let _menhir_action_81 =
  fun _endpos_e_ _startpos__1_ e s ->
    ...
    (
# 150 "parser.mly"
                               ( { stmt = SDecl(s, e); loc = (_startpos,_endpos) } )
# 1379 "parser.ml"
     : (Ast.stmt))
...
let _menhir_action_82 =
  fun _endpos_e_ _startpos__1_ e s ->
    ...
    (
# 151 "parser.mly"
                                  ( { stmt = SVar(s,e); loc = (_startpos,_endpos) } )
# 1389 "parser.ml"
     : (Ast.stmt))
...
include struct
  ...
  and _menhir_run_147 : type  ttv_stack. ((ttv_stack, _menhir_box_file) _menhir_cell1_LPAR, _menhir_box_file) _menhir_cell1_loption_separated_nonempty_list_COMMA_param__ _menhir_cell0_RPAR -> _ -> _ -> _ -> _ -> _ -> _menhir_box_file =
    fun _menhir_stack _menhir_lexbuf _menhir_lexer _endpos _v _tok ->
      ...
      let MenhirCell1_LPAR (_menhir_stack, _menhir_s, _) = _menhir_stack in
      let (_endpos_e_, e) = (_endpos, _v) in
      let _v = _menhir_action_49 e xs in
      _menhir_goto_funbody _menhir_stack _menhir_lexbuf _menhir_lexer _endpos_e_ _v _menhir_s _tok
